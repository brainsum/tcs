 ...
 *
 * This solves the problem of text boxes with the element order of TITLE,
 * IMAGE, TEXT to have an equally high title, so the images are lined up to
 * each other nicely
 *
 */
(function ($, Drupal) {
